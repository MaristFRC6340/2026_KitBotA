  ...
  private void configureBindings() {
    ...
    */
    ...
    operatorController.rightBumper()
        .whileTrue(ballSubsystem.feederSpeedCommand(ballSubsystem, FEEDER_LAUNCH_POWER)); { 
        }
        
    operatorController.leftBumper()
        .whileTrue(ballSubsystem.feederSpeedCommand(ballSubsystem, FEEDER_STIR_POWER)); {
